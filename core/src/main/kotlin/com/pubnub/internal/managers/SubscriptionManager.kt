...
import com.pubnub.internal.builder.ConnectedStatusAnnouncedOperation
import com.pubnub.internal.builder.NoOpOperation
import com.pubnub.internal.builder.PresenceOperation
import com.pubnub.internal.builder.PubSubOperation
import com.pubnub.internal.builder.StateOperation
import com.pubnub.internal.builder.SubscribeOperation
import com.pubnub.internal.builder.TimetokenRegionOperation
import com.pubnub.internal.builder.UnsubscribeOperation
import com.pubnub.internal.callbacks.Listener
import com.pubnub.internal.callbacks.ReconnectionCallback
...
import com.pubnub.internal.workers.SubscribeMessageWorker
import java.util.Timer
import java.util.concurrent.LinkedBlockingQueue
import kotlin.concurrent.timerTask

internal class SubscriptionManager(val pubnub: PubNub, private val listenerManager: ListenerManager<PubNub>, private val subscriptionState: StateManager = StateManager()) {
    ...
    internal fun adaptUnsubscribeBuilder(unsubscribeOperation: UnsubscribeOperation) {
        if (!pubnub.configuration.suppressLeaveEvents) {
            Leave(pubnub).apply {
                ...
                if (!status.isError || status.category != PNStatusCategory.PNAccessDeniedCategory) {
                    listenerManager.announce(status)
                }
            }
        }
