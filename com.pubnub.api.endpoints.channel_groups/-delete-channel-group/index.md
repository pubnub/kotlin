...
| Name | Summary |
|---|---|
| [channelGroup](channel-group.md) | The channel group to remove.`lateinit var channelGroup: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html) |
