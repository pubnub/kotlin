...
import com.pubnub.kmp.endpoints.message_actions.GetMessageActionsImpl
...
import com.pubnub.kmp.endpoints.objects.membership.AddMembershipsImpl
...
//        pubNubObjC.removeEventListenerWithListener(listener)
    ...
    override fun deleteMessages(channels: List<String>, start: Long?, end: Long?): DeleteMessages {
        return com.pubnub.kmp.endpoints.DeleteMessagesImpl(
            pubnub = pubNubObjC,
            channels = channels,
            start = start,
            end = end
