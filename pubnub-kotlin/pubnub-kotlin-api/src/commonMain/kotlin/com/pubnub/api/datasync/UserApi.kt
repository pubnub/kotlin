...
/**
 * Nested accessor for DataSync User operations, reached via [DataSync.user].
 *
...
interface UserApi {
     ...
     */
    fun delete(userId: String, ifMatch: String? = null): RemoveUser
