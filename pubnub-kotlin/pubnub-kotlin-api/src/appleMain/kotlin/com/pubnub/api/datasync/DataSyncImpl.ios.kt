...
internal class EntityApiImpl : EntityApi {
    override fun get(entityId: String): GetEntity = throw NotImplementedError("DataSync is not implemented on the Apple target")
    ...
    override fun create(
        ...
        status: String?,
        payload: Any?,
    ): CreateEntity = throw NotImplementedError("DataSync is not implemented on the Apple target")

    override fun delete(entityId: String, ifMatch: String?): RemoveEntity =
        throw NotImplementedError("DataSync is not implemented on the Apple target")
}
