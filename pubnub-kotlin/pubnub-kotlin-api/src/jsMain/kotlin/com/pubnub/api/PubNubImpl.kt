...
class PubNubImpl(override val configuration: PNConfiguration) : PubNub {
    ...
    override fun publish(
        ...
        val params = createJsObject<PubNubJs.PublishParameters> {
    ...
    override fun fire(channel: String, message: Any, meta: Any?, usePost: Boolean, ttl: Int?): Publish {
        val params = createJsObject<PubNubJs.FireParameters> {
            this.message = message
            this.channel = channel
            this.meta = meta
            this.sendByPost = usePost
        }
        return FireImpl(jsPubNub, params)
    }

    override fun signal(channel: String, message: Any): Signal {
        val params = createJsObject<PubNubJs.SignalParameters> {
            this.message = message
            this.channel = channel
        }
        return SignalImpl(jsPubNub, params)
    }
    ...
    override fun fetchMessages(
        ...
        return FetchMessagesImpl(jsPubNub, params)
    }
