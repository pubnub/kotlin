...
interface [History](index.md) : [Endpoint](../../com.pubnub.api/-endpoint/index.md)&lt;[PNHistoryResult](../../com.pubnub.api.models.consumer.history/-p-n-history-result/index.md)&gt; 
...
| [async](index.md#-2071998248%2FFunctions%2F-167468485) | [jvm]<br>abstract override fun [async](index.md#-2071998248%2FFunctions%2F-167468485)(callback: [Consumer](../../com.pubnub.api.v2.callbacks/-consumer/index.md)&lt;[Result](../../com.pubnub.api.v2.callbacks/-result/index.md)&lt;[PNHistoryResult](../../com.pubnub.api.models.consumer.history/-p-n-history-result/index.md)&gt;&gt;)<br>Run the action asynchronously, without blocking the calling thread and delivering the result through the [callback](index.md#-2071998248%2FFunctions%2F-167468485). |
...
| [sync](../../com.pubnub.api.endpoints.remoteaction/-remote-action/sync.md) | [jvm]<br>abstract fun [sync](../../com.pubnub.api.endpoints.remoteaction/-remote-action/sync.md)(): [PNHistoryResult](../../com.pubnub.api.models.consumer.history/-p-n-history-result/index.md)<br>Run the action synchronously, potentially blocking the calling thread. |
