//[pubnub-kotlin-api](../../../../index.md)/[com.pubnub.api.enums](../../index.md)/[PNReconnectionPolicy](../index.md)/[EXPONENTIAL](index.md)

# EXPONENTIAL

[EXPONENTIAL](index.md)

The SDK will try to reconnect to the network by doing so in non-fixed intervals. ie. the interval between retries is another power of 2, starting from 0 to 5.
