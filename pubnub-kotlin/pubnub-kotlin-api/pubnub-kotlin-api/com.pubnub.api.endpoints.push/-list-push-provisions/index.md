...
expect interface [ListPushProvisions](index.md) : [PNFuture](../../com.pubnub.kmp/-p-n-future/index.md)&lt;[PNPushListProvisionsResult](../../com.pubnub.api.models.consumer.push/-p-n-push-list-provisions-result/index.md)&gt; actual interface [ListPushProvisions](index.md)actual interface [ListPushProvisions](index.md) : [Endpoint](../../com.pubnub.api/-endpoint/index.md)&lt;[PNPushListProvisionsResult](../../com.pubnub.api.models.consumer.push/-p-n-push-list-provisions-result/index.md)&gt; 
...
| |
|---|
| [ListPushProvisionsImpl](../-list-push-provisions-impl/index.md) |
...
| [async](../../../../../pubnub-kotlin/pubnub-kotlin-api/com.pubnub.api.endpoints.remoteaction/-remote-action/async.md) | [jvm]<br>abstract override fun [async](index.md#358720268%2FFunctions%2F-167468485)(callback: [Consumer](../../com.pubnub.api.v2.callbacks/-consumer/index.md)&lt;[Result](../../com.pubnub.api.v2.callbacks/-result/index.md)&lt;[PNPushListProvisionsResult](../../com.pubnub.api.models.consumer.push/-p-n-push-list-provisions-result/index.md)&gt;&gt;)<br>Run the action asynchronously, without blocking the calling thread and delivering the result through the [callback](index.md#358720268%2FFunctions%2F-167468485).<br>[common]<br>abstract fun [async](index.md#-120957800%2FFunctions%2F-1863117221)(callback: [Consumer](../../com.pubnub.api.v2.callbacks/-consumer/index.md)&lt;[Result](../../com.pubnub.api.v2.callbacks/-result/index.md)&lt;[PNPushListProvisionsResult](../../com.pubnub.api.models.consumer.push/-p-n-push-list-provisions-result/index.md)&gt;&gt;) |
...
| [sync](../../com.pubnub.api.endpoints.remoteaction/-remote-action/sync.md) | [jvm]<br>abstract fun [sync](../../com.pubnub.api.endpoints.remoteaction/-remote-action/sync.md)(): [PNPushListProvisionsResult](../../com.pubnub.api.models.consumer.push/-p-n-push-list-provisions-result/index.md)<br>Run the action synchronously, potentially blocking the calling thread. |
