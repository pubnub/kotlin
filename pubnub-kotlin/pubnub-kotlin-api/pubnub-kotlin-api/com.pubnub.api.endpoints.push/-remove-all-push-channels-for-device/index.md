...
expect interface [RemoveAllPushChannelsForDevice](index.md) : [PNFuture](../../com.pubnub.kmp/-p-n-future/index.md)&lt;[PNPushRemoveAllChannelsResult](../../com.pubnub.api.models.consumer.push/-p-n-push-remove-all-channels-result/index.md)&gt; actual interface [RemoveAllPushChannelsForDevice](index.md)actual interface [RemoveAllPushChannelsForDevice](index.md) : [Endpoint](../../com.pubnub.api/-endpoint/index.md)&lt;[PNPushRemoveAllChannelsResult](../../com.pubnub.api.models.consumer.push/-p-n-push-remove-all-channels-result/index.md)&gt; 
...
| |
|---|
| [RemoveAllPushChannelsForDeviceImpl](../-remove-all-push-channels-for-device-impl/index.md) |
...
| [async](../../../../../pubnub-kotlin/pubnub-kotlin-api/com.pubnub.api.endpoints.remoteaction/-remote-action/async.md) | [jvm]<br>abstract override fun [async](index.md#-1558412781%2FFunctions%2F-167468485)(callback: [Consumer](../../com.pubnub.api.v2.callbacks/-consumer/index.md)&lt;[Result](../../com.pubnub.api.v2.callbacks/-result/index.md)&lt;[PNPushRemoveAllChannelsResult](../../com.pubnub.api.models.consumer.push/-p-n-push-remove-all-channels-result/index.md)&gt;&gt;)<br>Run the action asynchronously, without blocking the calling thread and delivering the result through the [callback](index.md#-1558412781%2FFunctions%2F-167468485).<br>[common]<br>abstract fun [async](index.md#2003424519%2FFunctions%2F-1863117221)(callback: [Consumer](../../com.pubnub.api.v2.callbacks/-consumer/index.md)&lt;[Result](../../com.pubnub.api.v2.callbacks/-result/index.md)&lt;[PNPushRemoveAllChannelsResult](../../com.pubnub.api.models.consumer.push/-p-n-push-remove-all-channels-result/index.md)&gt;&gt;) |
...
| [sync](../../com.pubnub.api.endpoints.remoteaction/-remote-action/sync.md) | [jvm]<br>abstract fun [sync](../../com.pubnub.api.endpoints.remoteaction/-remote-action/sync.md)(): [PNPushRemoveAllChannelsResult](../../com.pubnub.api.models.consumer.push/-p-n-push-remove-all-channels-result/index.md)<br>Run the action synchronously, potentially blocking the calling thread. |
