...
expect interface [RemoveChannelsFromPush](index.md) : [PNFuture](../../com.pubnub.kmp/-p-n-future/index.md)&lt;[PNPushRemoveChannelResult](../../com.pubnub.api.models.consumer.push/-p-n-push-remove-channel-result/index.md)&gt; actual interface [RemoveChannelsFromPush](index.md)actual interface [RemoveChannelsFromPush](index.md) : [Endpoint](../../com.pubnub.api/-endpoint/index.md)&lt;[PNPushRemoveChannelResult](../../com.pubnub.api.models.consumer.push/-p-n-push-remove-channel-result/index.md)&gt; 
...
| |
|---|
| [RemoveChannelsFromPushImpl](../-remove-channels-from-push-impl/index.md) |
...
| [async](../../../../../pubnub-kotlin/pubnub-kotlin-api/com.pubnub.api.endpoints.remoteaction/-remote-action/async.md) | [jvm]<br>abstract override fun [async](index.md#-1216397471%2FFunctions%2F-167468485)(callback: [Consumer](../../com.pubnub.api.v2.callbacks/-consumer/index.md)&lt;[Result](../../com.pubnub.api.v2.callbacks/-result/index.md)&lt;[PNPushRemoveChannelResult](../../com.pubnub.api.models.consumer.push/-p-n-push-remove-channel-result/index.md)&gt;&gt;)<br>Run the action asynchronously, without blocking the calling thread and delivering the result through the [callback](index.md#-1216397471%2FFunctions%2F-167468485).<br>[common]<br>abstract fun [async](index.md#984886357%2FFunctions%2F-1863117221)(callback: [Consumer](../../com.pubnub.api.v2.callbacks/-consumer/index.md)&lt;[Result](../../com.pubnub.api.v2.callbacks/-result/index.md)&lt;[PNPushRemoveChannelResult](../../com.pubnub.api.models.consumer.push/-p-n-push-remove-channel-result/index.md)&gt;&gt;) |
...
| [sync](../../com.pubnub.api.endpoints.remoteaction/-remote-action/sync.md) | [jvm]<br>abstract fun [sync](../../com.pubnub.api.endpoints.remoteaction/-remote-action/sync.md)(): [PNPushRemoveChannelResult](../../com.pubnub.api.models.consumer.push/-p-n-push-remove-channel-result/index.md)<br>Run the action synchronously, potentially blocking the calling thread. |
