package com.pubnub.internal.kotlin.endpoints.objects.membership
 ...
 */
class GetMembershipsImpl internal constructor(getMemberships: GetMemberships) :
    ...
    override fun convertAction(remoteAction: ExtendedRemoteAction<com.pubnub.internal.models.consumer.objects.membership.PNChannelMembershipArrayResult>): ExtendedRemoteAction<PNChannelMembershipArrayResult> {
        return MappingRemoteAction(remoteAction, com.pubnub.internal.models.consumer.objects.membership.PNChannelMembershipArrayResult::toApi)
    }
}
