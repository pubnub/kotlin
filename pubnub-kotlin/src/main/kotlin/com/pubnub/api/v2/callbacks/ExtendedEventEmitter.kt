...
// * to utilize [BaseEventEmitter.addListener].
// *
...
// * ```
// */
// @Suppress("INVISIBLE_REFERENCE", "INVISIBLE_MEMBER", "INVISIBLE_SETTER")
// var BaseEventEmitter.onMessage: ((PNMessageResult) -> Unit)?
//    get() = (this as com.pubnub.internal.v2.callbacks.EventEmitter).onMessage
//    set(value) {
//        (this as com.pubnub.internal.v2.callbacks.EventEmitter).onMessage = value
//    }
//
// /**
...
// * ```
// */
// var BaseEventEmitter.onObjects: ((PNObjectEventResult) -> Unit)?
//    get() {
//        return (this as com.pubnub.internal.v2.callbacks.EventEmitter).onObjects
//    }
//    set(value) {
//        (this as com.pubnub.internal.v2.callbacks.EventEmitter).onObjects = value?.let { callback ->
//            { callback(it.toApi()) }
//        }
//    }
//
