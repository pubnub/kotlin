//[pubnub-kotlin-core-api](../../../../index.md)/[com.pubnub.api.v2](../../index.md)/[PNConfiguration](../index.md)/[Builder](index.md)/[connectionPoolMaxIdleConnections](connection-pool-max-idle-connections.md)

# connectionPoolMaxIdleConnections

[jvm]\
abstract var [connectionPoolMaxIdleConnections](connection-pool-max-idle-connections.md): [Int](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html)
