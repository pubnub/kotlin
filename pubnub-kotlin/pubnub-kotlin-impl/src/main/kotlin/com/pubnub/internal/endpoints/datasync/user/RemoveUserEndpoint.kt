...
class RemoveUserEndpoint internal constructor(
...
) : EndpointCore<Void, DataSyncRemoveUserResult>(pubnub), RemoveUser {
    ...
    override fun createResponse(input: Response<Void>): DataSyncRemoveUserResult {
        // DeleteSuccessResponse has an empty body, so surface the HTTP status code.
        return DataSyncRemoveUserResult(input.code())
    }
