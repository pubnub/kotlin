...
Implement this interface and pass it into [EventEmitter.addListener](../../../../pubnub-gson/com.pubnub.api.v2.callbacks/-event-emitter/add-listener.md) to listen for events from the PubNub real-time network.
