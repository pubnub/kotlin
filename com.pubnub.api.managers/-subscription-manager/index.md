...
| [removeListener](remove-listener.md) | `fun removeListener(listener: `[`Listener`](../../com.pubnub.api.callbacks/-listener.md)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
