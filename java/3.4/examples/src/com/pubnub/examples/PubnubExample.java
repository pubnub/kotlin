...
public class PubnubExample {
    ...
    public static void main(String[] params) {
         ...
         * System.out.println("\nRunning publish()"); pex.publish();
         * 
         * System.out.println("\nRunning history()"); pex.history();
         * 
         * System.out.println("\nRunning here_now()"); pex.hereNow();
         * 
         * System.out.println("\nRunning detailedHistory()");
         * pex.detailedHistory(); }
         * 
         * System.out.println("\nRunning presence()"); pex.presence();
         */

        System.out.println("\nRunning subscribe()");
        pex.subscribe(new String[] { "hello_world" + "-"
                + String.valueOf(counter) });

        while (true) {
            counter = (counter + 1) % 9;
            try {
                // Thread.sleep((long) (Math.floor((Math.random()) % 17 ) *
                // 1000));
                Thread.sleep(20000);
    ...
    public void publish() {
        ...
        _pubnub.publish(args, new Callback() {
            public void successCallback(String channel, Object message) {
                notifyUser(channel + " : " + message.getClass() + " : "
                        + message.toString());
            }
