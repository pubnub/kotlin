    ...
    fun i_subscribe() {
        state.pubnub.addListener(object : SubscribeCallback() {
            ...
            override fun uuid(pubnub: PubNub, pnUUIDMetadataResult: PNUUIDMetadataResult) {
                state.messagesList.add(pnUUIDMetadataResult)
            }

            override fun channel(pubnub: PubNub, pnChannelMetadataResult: PNChannelMetadataResult) {
                state.messagesList.add(pnChannelMetadataResult)
            }

            override fun membership(pubnub: PubNub, pnMembershipResult: PNMembershipResult) {
                state.messagesList.add(pnMembershipResult)
            }
        ...
        state.pubnub.subscribe().channels(listOf(state.channelName)).execute()
    }
