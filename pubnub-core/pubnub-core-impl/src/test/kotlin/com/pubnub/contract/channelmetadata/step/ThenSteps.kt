...
class ThenSteps(
    ...
    fun the_channel_metadata_for_channel_contains_updated(
        @Suppress("UNUSED_PARAMETER") channelFileName: String,
    ) {
    ...
    fun the_response_contains_list_with_and_channel_metadata(
