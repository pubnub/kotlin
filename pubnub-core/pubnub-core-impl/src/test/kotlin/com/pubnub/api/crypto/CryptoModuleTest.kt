...
class CryptoModuleTest {
    ...
    fun `can createLegacyCryptoModule`() {
        ...
        // when
        val legacyCryptoModule = CryptoModule.createLegacyCryptoModule(cipherKey) as CryptoModuleImpl
    ...
    fun `can createAesCbcCryptoModule`() {
        ...
        // when
        val aesCbcCryptoModule = CryptoModule.createAesCbcCryptoModule(cipherKey) as CryptoModuleImpl
    ...
    fun `can createNewCryptoModule`() {
        ...
        // when
        val newCryptoModule = CryptoModule.createNewCryptoModule(defaultCryptor = AesCbcCryptor(cipherKey)) as CryptoModuleImpl
