...
class FetchMessagesTestSuite : com.pubnub.internal.suite.CoreEndpointTestSuite<FetchMessagesEndpoint, PNFetchMessagesResult>() {
    override fun pnOperation() = PNOperationType.PNFetchMessagesOperation

    override fun requiredKeys() = com.pubnub.internal.suite.SUB + com.pubnub.internal.suite.AUTH

    override fun snippet(): FetchMessagesEndpoint =
