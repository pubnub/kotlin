...
class RemoveChannelChannelGroupTestSuite :
    com.pubnub.internal.suite.CoreEndpointTestSuite<RemoveChannelChannelGroupEndpoint, PNChannelGroupsRemoveChannelResult>() {
    override fun pnOperation() = PNOperationType.PNRemoveChannelsFromGroupOperation

    override fun requiredKeys() = com.pubnub.internal.suite.SUB + com.pubnub.internal.suite.AUTH

    override fun snippet(): RemoveChannelChannelGroupEndpoint {
