...
class RemoveMessageActionsTestSuite :
    com.pubnub.internal.suite.CoreEndpointTestSuite<RemoveMessageActionEndpoint, PNRemoveMessageActionResult>() {
    override fun pnOperation() = PNOperationType.PNDeleteMessageAction

    override fun requiredKeys() = com.pubnub.internal.suite.SUB + com.pubnub.internal.suite.AUTH

    override fun snippet(): RemoveMessageActionEndpoint {
