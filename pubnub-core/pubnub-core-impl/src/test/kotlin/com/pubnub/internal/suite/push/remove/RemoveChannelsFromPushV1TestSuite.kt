...
class RemoveChannelsFromPushV1TestSuite :
    com.pubnub.internal.suite.CoreEndpointTestSuite<RemoveChannelsFromPushEndpoint, PNPushRemoveChannelResult>() {
    override fun pnOperation() = PNOperationType.PNRemovePushNotificationsFromChannelsOperation

    override fun requiredKeys() = com.pubnub.internal.suite.SUB + com.pubnub.internal.suite.AUTH

    override fun snippet(): RemoveChannelsFromPushEndpoint {
