...
) : BasePNConfigurationImpl(userId) {
    class Builder internal constructor(override var userId: UserId) :
        BasePNConfigurationImpl.Builder(BasePNConfigurationImpl(userId)) {
            /**
            ...
            fun build(): BasePNConfigurationImpl {
                return TestPNConfigurationImpl(
                    userId = userId,
