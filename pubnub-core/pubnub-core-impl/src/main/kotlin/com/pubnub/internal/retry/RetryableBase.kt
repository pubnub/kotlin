...
internal abstract class RetryableBase<T>(
    ...
    companion object {
        ...
        private val retryableStatusCodes =
            mapOf(
    ...
    internal val isRetryConfSetForThisRestCall =
    ...
    private fun calculateDelayForTooManyRequestError(response: Response<T>): Duration {
