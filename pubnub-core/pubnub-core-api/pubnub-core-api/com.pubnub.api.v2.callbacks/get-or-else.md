//[pubnub-core-api](../../index.md)/[com.pubnub.api.v2.callbacks](index.md)/[getOrElse](get-or-else.md)
...
Note, that this function rethrows any [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html) exception thrown by [onFailure](get-or-else.md) function.

This function is a shorthand for `fold(onSuccess = { it }, onFailure = onFailure)` (see [fold](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/index.html)).
