...
object PubnubDevConsole {
    ...
    def displayMenuOptions() {
        ...
        println("ENTER 12 FOR Toggle Resume On Reconnect")
        println("ENTER 13 FOR Setting MAX Retries")
        println("ENTER 14 FOR Setting Retry Interval")
        println("ENTER 15 FOR Setting Subscribe Timeout")
        println("ENTER 16 FOR Setting Non Subscribe Timeout")
        println("ENTER 17 FOR Setting/Unsetting auth key1")
