...
class SubscribeV2Spec extends fixture.FunSpec with AwaitilitySupport  with BeforeAndAfterAll {
  ...
  describe("SubscribeV2()") {
    ...
    it("should receive JSON Object when subscribed with filtering attribute foo==bar " +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>

      var metadata = pubnubTestConfig.metadata
      var pubnub  = pubnubTestConfig.pubnub
      var channel = "channel-" + getRandom()
      var message = new JSONObject()
      var m = "message-" + getRandom(pubnubTestConfig.unicode)
      message.put("a", m)
      var testObj = new PnTest(3)
      ...
      pubnub.subscribe(channel, new Callback {
        ...
        override def successCallbackV2(channel: String, message1: Object, envelope: JSONObject) {
          ...
          assertTrue(message1.asInstanceOf[JSONObject].getString("a").equals(m))
    ...
    it("should be able to receive JSON Object successfully when subscribed with no filtering attribute" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed with filtering attribute foo==bar" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed with filtering attribute a==b" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
      var metadata = pubnubTestConfig.metadata
      var pubnub  = pubnubTestConfig.pubnub
      var channel = "channel-" + getRandom()
    ...
    it("should not receive JSON Object when subscribed with filtering attribute foo==b" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed with filtering attribute bar==foo" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should receive JSON Object when subscribed to wildcard channel with filtering attribute foo==bar " +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should be able to receive JSON Object successfully when subscribed to wildcard channel with no filtering attribute" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to wildcard channel with filtering attribute foo==bar" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to wildcard channel with filtering attribute a==b" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to wildcard channel with filtering attribute foo==b" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
      var metadata = pubnubTestConfig.metadata
      var pubnub  = pubnubTestConfig.pubnub
      var channel = "channel-" + getRandom()
    ...
    it("should not receive JSON Object when subscribed to wildcard channel with filtering attribute bar==foo" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
      var metadata = pubnubTestConfig.metadata
      var pubnub  = pubnubTestConfig.pubnub
      var channel = "channel-" + getRandom()
    ...
    it("should receive JSON Object when subscribed to channel and wildcard channel with filtering attribute foo==bar " +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
      ...
      var message_wildcard_c = new JSONObject()
      var m_w_c = "message-wildcard-" + getRandom(pubnubTestConfig.unicode)
      message_wildcard_c.put("a", m_w_c)
      ...
      pubnub.subscribe(channel, new Callback {
        ...
        override def connectCallback(channel1: String, message1: Object) {
          ...
          pubnub.subscribe(channel_wildcard, new Callback {
            ...
            override def successCallbackV2(channel: String, message1: Object, envelope: JSONObject) {
              testObj.test(true)
              assertTrue(message1.toString + " : " + message1.getClass(), (message1.getClass()).equals(message_wildcard_c.getClass()))
              assertTrue(message1.asInstanceOf[JSONObject].getString("a").equals(m_w_c))
            }
          })
        }
        override def successCallbackV2(channel: String, message1: Object, envelope: JSONObject) {
    ...
    it("should be able to receive JSON Object successfully when subscribed to channel and wildcard channel with no filtering attribute" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel and wildcard channel with filtering attribute foo==bar" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel and wildcard channel with filtering attribute a==b" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel and wildcard channel with filtering attribute foo==b" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel and wildcard channel with filtering attribute bar==foo" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should receive JSON Object when subscribed to channel group with filtering attribute foo==bar " +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
      ...
      var message_group_c = new JSONObject()
      var m_g_c = "message-group-" + getRandom(pubnubTestConfig.unicode)
      message_group_c.put("a", m_g_c)
      ...
      pubnub.channelGroupAddChannel(channel_group, channel_group_c, new Callback {
        ...
        override def successCallback(channel1: String, message1: Object) {
          ...
          pubnub.channelGroupSubscribe(Array(channel_group), new Callback {
            ...
            override def successCallbackV2(channel: String, message1: Object, envelope: JSONObject) {
              testObj.test(true)
              assertTrue(message1.toString + " : " + message1.getClass(), (message1.getClass()).equals(message_group_c.getClass()))
              assertTrue(message1.asInstanceOf[JSONObject].getString("a").equals(m_g_c))
              pubnub.channelGroupUnsubscribe(channel_group)
            }
    ...
    it("should be able to receive JSON Object successfully when subscribed to channel group with no filtering attribute" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel group  with filtering attribute foo==bar" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel group with filtering attribute a==b" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
      var metadata = pubnubTestConfig.metadata
      var pubnub  = pubnubTestConfig.pubnub
      var channel = "channel-" + getRandom()
    ...
    it("should not receive JSON Object when subscribed to channel group with filtering attribute foo==b" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel group with filtering attribute bar==foo" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should receive JSON Object when subscribed to channel and channel group with filtering attribute foo==bar " +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should receive JSON Object when subscribed to channel and channel group with filtering attribute foo==bar " +
      " when JSON Object published with metadata foo:bar" +
      ", and when unsubscribed on receiving message") { pubnubTestConfig =>
    ...
    it("should be able to receive JSON Object successfully when subscribed to channel and channel group with no filtering attribute" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel and channel group  with filtering attribute foo==bar" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel and channel group with filtering attribute a==b" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel and channel group with filtering attribute foo==b" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel and channel group with filtering attribute bar==foo" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should receive JSON Object when subscribed to channel, wildcard channel" +
      " and channel group with filtering attribute foo==bar " +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
    ...
    it("should be able to receive JSON Object successfully when subscribed to channel, wildcard channel" +
      " and channel group with no filtering attribute" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should be able to receive JSON Object successfully when subscribed to channel, wildcard channel" +
      " and channel group with no filtering attribute" +
      " when JSON Object published with no metadata," +
      " when unsubscribed after receiving message") { pubnubTestConfig =>
    ...
    it("should not receive JSON Object when subscribed to channel, wildcard channel" +
      " and channel group  with filtering attribute foo==bar" +
      " when JSON Object published with no metadata") { pubnubTestConfig =>
    ...
    it("should not receive JSONObject when subscribed to channel, wildcard channel " +
      "and channel group with filtering attribute bar==foo" +
      " when JSON Object published with metadata foo:bar") { pubnubTestConfig =>
