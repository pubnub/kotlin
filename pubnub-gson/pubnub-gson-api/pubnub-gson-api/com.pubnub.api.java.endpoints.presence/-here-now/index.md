...
| [includeState](include-state.md) | [jvm]<br>abstract fun [includeState](include-state.md)(includeState: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-boolean/index.html)): [HereNow](index.md) |
| [includeUUIDs](include-u-u-i-ds.md) | [jvm]<br>abstract fun [includeUUIDs](include-u-u-i-ds.md)(includeUUIDs: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-boolean/index.html)): [HereNow](index.md) |
