//[pubnub-gson-api](../../../index.md)/[com.pubnub.api.java.endpoints.push](../index.md)/[ListPushProvisions](index.md)

# ListPushProvisions

[jvm]\
interface [ListPushProvisions](index.md) : [Endpoint](../../com.pubnub.api.java.endpoints/-endpoint/index.md)&lt;[T](../../com.pubnub.api.java.endpoints/-endpoint/index.md)&gt;
...
| [deviceId](device-id.md) | [jvm]<br>abstract fun [deviceId](device-id.md)(deviceId: [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)): [ListPushProvisions](index.md) |
| [environment](environment.md) | [jvm]<br>abstract fun [environment](environment.md)(environment: [PNPushEnvironment](../../../../../pubnub-kotlin/pubnub-kotlin-core-api/pubnub-kotlin-core-api/com.pubnub.api.enums/-p-n-push-environment/index.md)): [ListPushProvisions](index.md) |
...
| [pushType](push-type.md) | [jvm]<br>abstract fun [pushType](push-type.md)(pushType: [PNPushType](../../../../../pubnub-kotlin/pubnub-kotlin-core-api/pubnub-kotlin-core-api/com.pubnub.api.enums/-p-n-push-type/index.md)): [ListPushProvisions](index.md) |
...
| [topic](topic.md) | [jvm]<br>abstract fun [topic](topic.md)(topic: [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)): [ListPushProvisions](index.md) |
