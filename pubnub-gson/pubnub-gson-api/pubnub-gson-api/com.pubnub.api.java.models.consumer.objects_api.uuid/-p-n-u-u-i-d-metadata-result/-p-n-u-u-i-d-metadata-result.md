//[pubnub-gson-api](../../../index.md)/[com.pubnub.api.java.models.consumer.objects_api.uuid](../index.md)/[PNUUIDMetadataResult](index.md)/[PNUUIDMetadataResult](-p-n-u-u-i-d-metadata-result.md)
