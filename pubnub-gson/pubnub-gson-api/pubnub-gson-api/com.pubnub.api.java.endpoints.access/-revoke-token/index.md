//[pubnub-gson-api](../../../index.md)/[com.pubnub.api.java.endpoints.access](../index.md)/[RevokeToken](index.md)

# RevokeToken

[jvm]\
interface [RevokeToken](index.md) : [Endpoint](../../com.pubnub.api.java.endpoints/-endpoint/index.md)&lt;[T](../../com.pubnub.api.java.endpoints/-endpoint/index.md)&gt;
...
| [token](token.md) | [jvm]<br>abstract fun [token](token.md)(token: [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)): [RevokeToken](index.md) |
