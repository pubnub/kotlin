...
@NoArgsConstructor
@ToString
public class DataSyncGetEntitiesResult {
    private int status;
    private List<DataSyncEntity> data;
    ...
    public DataSyncGetEntitiesResult(int status, List<DataSyncEntity> data, @NotNull PNDataSyncPage next) {
        this.status = status;
        this.data = data;
        this.next = next;
    }
