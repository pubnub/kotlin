...
@NoArgsConstructor
@ToString
public class DataSyncGetChannelsResult {
    private int status;
    private List<DataSyncChannel> data;
    ...
    public DataSyncGetChannelsResult(int status, List<DataSyncChannel> data, @NotNull PNDataSyncPage next) {
        this.status = status;
        this.data = data;
        this.next = next;
    }
