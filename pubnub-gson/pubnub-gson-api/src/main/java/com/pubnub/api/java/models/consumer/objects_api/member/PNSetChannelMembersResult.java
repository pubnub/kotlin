...
public class PNSetChannelMembersResult extends EntityArrayEnvelope<PNMembers> {
    ...
    private PNSetChannelMembersResult(Integer status, Integer totalCount, String prev, String next, List<PNMembers> data) {
        this.status = status;
    ...
    public static PNSetChannelMembersResult from(PNMemberArrayResult result) {
