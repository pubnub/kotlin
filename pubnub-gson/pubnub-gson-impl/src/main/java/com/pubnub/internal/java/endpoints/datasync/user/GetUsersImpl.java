...
public class GetUsersImpl
        extends DelegatingEndpoint<com.pubnub.api.models.consumer.datasync.user.DataSyncGetUsersResult, DataSyncGetUsersResult>
        implements GetUsers {
    ...
    @NotNull
    @Override
    protected ExtendedRemoteAction<DataSyncGetUsersResult> mapResult(
            @NotNull ExtendedRemoteAction<com.pubnub.api.models.consumer.datasync.user.DataSyncGetUsersResult> action) {
        return new MappingRemoteAction<>(action, result -> {
            com.pubnub.api.models.consumer.datasync.PNDataSyncPage kNext = result.getNext();
            return new DataSyncGetUsersResult(
                    result.getStatus(),
                    result.getData().stream().map(DataSyncUserConverter::from).collect(Collectors.toList()),
    ...
    @Override
    @NotNull
    protected Endpoint<com.pubnub.api.models.consumer.datasync.user.DataSyncGetUsersResult> createRemoteAction() {
