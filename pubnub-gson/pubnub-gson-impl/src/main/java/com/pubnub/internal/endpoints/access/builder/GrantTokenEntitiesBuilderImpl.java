...
public class GrantTokenEntitiesBuilderImpl extends AbstractGrantTokenBuilderImpl<GrantTokenEntitiesBuilderImpl>
        implements GrantTokenEntitiesBuilder {

    public GrantTokenEntitiesBuilderImpl(PubNubCore pubnub, GrantToken grantToken) {
