...
public class GetChannelsImpl
        extends DelegatingEndpoint<com.pubnub.api.models.consumer.datasync.channel.DataSyncGetChannelsResult, DataSyncGetChannelsResult>
    ...
    @NotNull
    @Override
    protected ExtendedRemoteAction<DataSyncGetChannelsResult> mapResult(
            @NotNull ExtendedRemoteAction<com.pubnub.api.models.consumer.datasync.channel.DataSyncGetChannelsResult> action) {
        return new MappingRemoteAction<>(action, result -> {
            com.pubnub.api.models.consumer.datasync.PNDataSyncPage kNext = result.getNext();
            return new DataSyncGetChannelsResult(
                    result.getStatus(),
                    result.getData().stream().map(DataSyncChannelConverter::from).collect(Collectors.toList()),
    ...
    @Override
    @NotNull
    protected Endpoint<com.pubnub.api.models.consumer.datasync.channel.DataSyncGetChannelsResult> createRemoteAction() {
