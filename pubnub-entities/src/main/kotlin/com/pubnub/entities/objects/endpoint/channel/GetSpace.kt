...
) : Endpoint<EntityEnvelope<PNSpace>, PNSpaceResult>(pubnub, pubnub.telemetryManager, pubnub.retrofitManager, pubnub.tokenManager) {
...
val RetrofitManager.objectsService: ObjectsService
    get() = this.transactionInstance.create()
