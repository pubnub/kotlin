...
import com.pubnub.api.endpoints.pubsub.ConfigurationNeededForEndpoint
import com.pubnub.api.endpoints.pubsub.JsonMapperManagerForEndpoint
import com.pubnub.api.endpoints.pubsub.PNInstanceIdProvider
import com.pubnub.api.endpoints.pubsub.TelemetryManagerExternal
import com.pubnub.api.endpoints.pubsub.TokenRetriever
...
//    protected val pubnub: PubNub,
    ...
    protected fun createBaseParams(): HashMap<String, String> {
        ...
        map["uuid"] = configurationNeededForEndpoint.getUserId().value
    ...
    protected open fun validateParams() {
        if (isSubKeyRequired() && !configurationNeededForEndpoint.getSubscribeKey().isValid()) {
            throw PubNubException(PubNubError.SUBSCRIBE_KEY_MISSING)
        }
        if (isPubKeyRequired() && !configurationNeededForEndpoint.getPublishKey().isValid()) {
