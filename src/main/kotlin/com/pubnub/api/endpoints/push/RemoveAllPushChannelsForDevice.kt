...
class RemoveAllPushChannelsForDevice(pubnub: PubNub) : Endpoint<List<Any>, PNPushRemoveAllChannelsResult>(pubnub) {
    ...
    override fun createResponse(input: Response<List<Any>>): PNPushRemoveAllChannelsResult? {
