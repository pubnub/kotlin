...
/**
 * @see [PubNub.addMemberships]
 */
class AddMemberships internal constructor(
    pubnub: PubNub,
    private val channels: Collection<PNChannelWithCustom>,
    ...
    override fun doWork(queryParams: HashMap<String, String>): Call<EntityArrayEnvelope<PNChannelMembership>> {
        ...
        return pubnub.retrofitManager.objectsService.patchMemberships(
            ...
            options = params,
            body = ChangeMembershipInput(set = channels.map {
                MembershipInput(
                    channel = ChannelId(it.channel),
                    custom = it.custom
                )
            })
        )
    ...
    override fun operationType(): PNOperationType {
        return PNOperationType.PNAddMembershipsOperation
    }
}
