package com.pubnub.api.endpoints.history
...
class HistoryEndpointTest : BaseTest() {
    ...
    fun testSyncSuccess() {
        ...
        val (messages, startTimetoken, endTimetoken) = pubnub.history().apply {
            channel = "niceChannel"
            includeTimetoken = true
        }.sync()!!
    ...
    fun testOperationTypeSuccessAsync() {
        ...
        pubnub.history().apply {
            ...
            val (messages, startTimetoken, endTimetoken) = result!!
