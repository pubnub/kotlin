...
public class AddChannelChannelGroupEndpointTest extends TestHarness {
    ...
    public void beforeEach() throws IOException {
        partialAddChannelChannelGroup = this.createPubNubInstance(8080).addChannelChannelGroup();
    }
    ...
    public void testSyncSuccess() throws IOException, PubnubException, InterruptedException {
        ...
        boolean response = partialAddChannelChannelGroup.group("groupA").channels(Arrays.asList("ch1", "ch2")).sync();
    ...
    public void testSyncSuccessCustomUUID() throws IOException, PubnubException, InterruptedException {
        ...
        boolean response = partialAddChannelChannelGroup.group("groupA").channels(Arrays.asList("ch1", "ch2")).uuid("myCustomUUID").sync();
        assertThat(response, org.hamcrest.Matchers.equalTo(true));
    }
