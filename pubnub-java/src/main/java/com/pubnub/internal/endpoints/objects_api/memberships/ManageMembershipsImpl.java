...
public class ManageMembershipsImpl extends DelegatingEndpoint<PNManageMembershipResult> implements ManageMemberships {
    ...
    public ManageMembershipsImpl(Collection<PNChannelMembership> channelsToSet, Collection<PNChannelMembership> channelsToRemove, final InternalPubNubClient pubnubInstance) {
