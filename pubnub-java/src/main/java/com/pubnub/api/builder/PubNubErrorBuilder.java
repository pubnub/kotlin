...
public final class PubNubErrorBuilder {
    ...
    public static final PubNubError PNERROBJ_CONNECTION_NOT_SET = PubNubError.CONNECTION_NOT_SET;
    ...
    public static final PubNubError PNERROBJ_SPACEID_NULL_OR_EMPTY = PubNubError.SPACEID_NULL_OR_EMPTY;
}
