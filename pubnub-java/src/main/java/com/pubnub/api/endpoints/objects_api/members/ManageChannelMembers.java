...
public class ManageChannelMembers extends Endpoint<PNManageChannelMembersResult> {
    ...
    public ManageChannelMembers(String channel, Collection<PNUUID> uuidsToSet, Collection<PNUUID> uuidsToRemove, final com.pubnub.internal.PubNub pubnubInstance) {
