...
public class SetChannelMembers extends Endpoint<PNSetChannelMembersResult> {
    ...
    public SetChannelMembers(final com.pubnub.internal.PubNub pubnubInstance, String channel, Collection<PNUUID> uuids) {
        ...
        public ObjectsBuilderSteps.UUIDsStep<SetChannelMembers> channel(final String channel) {
            return new ObjectsBuilderSteps.UUIDsStep<SetChannelMembers>() {
                ...
                public SetChannelMembers uuids(@NotNull final Collection<PNUUID> uuids) {
                    return new SetChannelMembers(pubnubInstance, channel, uuids);
                }
            };
        }
    }
