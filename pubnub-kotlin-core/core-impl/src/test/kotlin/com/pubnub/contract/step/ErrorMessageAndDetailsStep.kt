...
class ErrorMessageAndDetailsStep(private val world: World) {
    ...
    fun i_see_the_error_message_and_details(
        message: String,
        details: String,
    ) {
        val exception = world.pnException!!
        assertThat(exception.errorMessage, Matchers.containsString(message))
        assertThat(exception.errorMessage, Matchers.containsString(details))
    }
}
