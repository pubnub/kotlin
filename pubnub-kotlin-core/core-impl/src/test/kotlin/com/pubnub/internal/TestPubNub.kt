...
class TestPubNub internal constructor(configuration: PNConfiguration, eventEnginesConf: EventEnginesConf = EventEnginesConf()) :
    BasePubNubImpl<
            ...
            InternalStatusListener>(configuration, eventEnginesConf) {
    ...
    override fun channelMetadata(id: String): BaseChannelMetadataImpl<InternalEventListener, BaseSubscriptionImpl<InternalEventListener>> {
        TODO("Not yet implemented")
    }
