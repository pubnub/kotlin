...
abstract class EndpointTestSuite<T : com.pubnub.internal.Endpoint<*, R>, R> : BaseTest() {
...
class OptionalScenario<R> {
    ...
    var additionalChecks: AsyncCheck<R> = { result: com.pubnub.api.v2.callbacks.Result<R> -> }
