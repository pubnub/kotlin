...
internal class TestPubNub(configuration: PNConfiguration, eventEnginesConf: EventEnginesConf = EventEnginesConf()) : BasePubNub(configuration, eventEnginesConf, ::BaseSubscriptionImpl, ::BaseSubscriptionSetImpl)
