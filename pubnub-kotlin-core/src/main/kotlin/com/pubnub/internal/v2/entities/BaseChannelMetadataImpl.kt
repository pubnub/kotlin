...
open class BaseChannelMetadataImpl<T : BaseSubscriptionImpl>(internal val pubnub: PubNubImpl, val channelName: ChannelName, private val subscriptionFactory: SubscriptionFactory<T>) : BaseChannelMetadata {
